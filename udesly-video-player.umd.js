! function(a) {
    ...
    var c = function() {
        function c(c, e) {
            ...
            i.remove(), j.removeAttribute("muted"), j.removeAttribute("loop"), j.removeAttribute("playsinline"), j.removeAttribute("data-wf-ignore"), this.injectStyle(c), this.videoWrapper.appendChild(j), this.video = j, this.video.onplaying = function() {
